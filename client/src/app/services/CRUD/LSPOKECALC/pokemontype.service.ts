...
export class PokemonTypeService {
   ...
   url = environment.api_lspokecalc + 'pokemontype/';
   ...
   post(pokemontype: PokemonType): Promise<any> {
      return this.http.post(this.url, JSON.stringify(pokemontype), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }

   put(pokemontype: PokemonType): Promise<any> {
      return this.http.put(this.url, JSON.stringify(pokemontype), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }

...
export class StatisticService {
   ...
   url = environment.api_lspokecalc + 'statistic/';
   ...
   post(statistic: Statistic): Promise<any> {
      return this.http.post(this.url, JSON.stringify(statistic), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }

   put(statistic: Statistic): Promise<any> {
      return this.http.put(this.url, JSON.stringify(statistic), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }
